...
async function getStaticProps() {
    // fetch data from an API
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://nathanifill:MongoDB123!@cluster0.pbm2uza.mongodb.net/meetups?retryWrites=true&w=majority");
